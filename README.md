...
OGGM v1.6.2 (latest release) was used for all simulations. For privacy, all filepaths have been replaced with 'custom_filepath'
...
<p align="center">
  ...
  <b>Simulated regional and subregional volume change of Alaska's land-terminating glaciers</b>
</p>
...
Whilst I have tried to make these functions as reusable as possible, their primary goal was to deliver the simulations, analyses, and plots required for my thesis, hence they would likely require tweaking for other uses. Arising following plenty of trial and error when dealing with such large datasets, much of the analysis and plotting code, whilst functional for my needs, is likely far from optimal. I have tried to expand the commenting of various lines of code to provide the rationale behind my decision making.

Finally please note that this repository was recreated from my original thesis repository to remove any mention of my candidate ID - the code files are unchanged, only some small restructuring of filepaths and reformatting of this README has been made. 
